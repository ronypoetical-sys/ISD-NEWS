    ...
    <footer className="bg-ink-900 text-ink-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Navigasi */}
          <div>
            <h4 className="text-xs font-bold text-ink-100 uppercase tracking-widest mb-5">Navigasi</h4>
            <ul className="space-y-2.5">
              {quickLinks.map(link => (
                <li key={link.to}>
                  ...
                  >
                    <span className="w-3 h-px bg-ink-600 group-hover:bg-brand-400 transition-all group-hover:w-4 inline-block"></span>
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Kategori */}
          <div>
            <h4 className="text-xs font-bold text-ink-100 uppercase tracking-widest mb-5">Kategori</h4>
            <ul className="space-y-2.5">
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-xs font-bold text-ink-100 uppercase tracking-widest mb-5">Newsletter Harian</h4>
      ...
      <div className="border-t border-ink-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-ink-500">
            &copy; {year} ISD NEWS. Seluruh hak cipta dilindungi undang-undang.
          </p>
