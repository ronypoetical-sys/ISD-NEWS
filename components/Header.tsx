...
const Header: React.FC = () => {
  ...
  // Duplicate headlines for seamless ticker loop
  ...
  return (
    <header className={`sticky top-0 z-50 transition-shadow duration-300 ${isScrolled ? 'header-scrolled' : ''}`} role="banner">
              ...
              {user ? (
                <div className="flex items-center gap-3">
                  ...
                  {user.role === UserRole.ADMIN && (
                    <Link
                      to="/admin"
                      className="bg-brand-500 text-white px-2 py-0.5 rounded text-xs font-medium hover:bg-brand-600 transition-colors"
      ...
      {latestHeadlines.length > 0 && (
        <div className="bg-brand-500 text-white py-1.5 overflow-hidden" aria-label="Berita terkini">
          <div className="max-w-7xl mx-auto px-4 flex items-center gap-3">
            <div
              className="flex-shrink-0 flex items-center gap-1.5 bg-white/20 px-2 py-0.5 rounded text-xs font-bold tracking-wider uppercase"
              aria-hidden="true"
            >
            ...
            {/* Ticker container */}
            <div className="ticker-outer flex-1" aria-live="polite" aria-atomic="false">
              <div className="ticker-inner text-sm font-light">
